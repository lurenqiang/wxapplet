// pages/service/reflectProblem/reflectProblem.js
...
Page({
   ...
   */
  data: {
    array: ['请选择反馈类型', '环境卫生', '公共设施', '小区服务', '其他'],
    index: 0,
    content: '',
    contentLength: 0,
    mobile: '',
  ...
  submitFeedback: function(e) {
    ...
    util.request(api.ReflectProblem, {
      phoneNumber: that.data.mobile,
      reflectProblemType: that.data.array[that.data.index],
